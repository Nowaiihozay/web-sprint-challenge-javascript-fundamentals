...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(){
    let displayName = [];
    zooAnimals.forEach(Wildlife => {
    displayName.push(`name: ${Wildlife.animal_name}, scientific: ${Wildlife.scientific_name}`)
      });
    return displayName;
    }
  ...
  */
  ...
  function lowerCaseNames(){
    let inferiorNames = zooAnimals.map(function(array){
    return array.animal_name.toLowerCase();
      })
    return inferiorNames;
    }
  ...
  */
  ...
  function lowPopulationAnimals(){
    let wildlife = zooAnimals.filter(function(array){
  ...
  */
  ...
  function USApop(){
    ...
    populationResult = zooAnimals.reduce(function(assemble, latest){
    return assemble + latest.population
    }, 0);
  ...
  */
  ...
  function consume(atm, btw, callback){
    return callback(atm, btw);
    }
